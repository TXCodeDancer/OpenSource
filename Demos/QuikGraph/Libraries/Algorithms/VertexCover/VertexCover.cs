...
namespace Algorithms.VertexCover
{
    ...
    {
        public static VertexList<int> Get(UndirectedGraph<int, Edge<int>> g, int seed = 123456) // Seeding with 456789, etc. may provide different CoverSet count
        {
        ...
        public static VertexList<string> Get(UndirectedGraph<string, TaggedEdge<string, string>> g, int seed = 123456) // Seeding with 456789, etc. may provide different CoverSet count
        {
