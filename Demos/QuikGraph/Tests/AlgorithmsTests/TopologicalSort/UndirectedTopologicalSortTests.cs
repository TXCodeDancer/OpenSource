...
{
    public class UndirectedTopologicalSortTests
    {
        [Theory]
        ...
        public void Test0(string inputFile)
        {
            ...
            var outputFile = @$"{directory}\TopologicalSort\UndirectedTopologicalSort\{file}";
            ...
            List<string> actual = TopologicalSortHelpers.UndirectedTopologicalSortHelper(nodes, edges);
