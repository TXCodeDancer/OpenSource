...
namespace Tests.AlgorithmsTests.TravelingSalesmanProblem
{
    public class TSPTests
    {
        ...
        public void Test0(string inputFile)
        {
            ...
            var outputFile = @$"{directory}\TravelingSalesmanProblem\TSPCost\Directed\{file}";
            ...
            List<string> actual = TavelingSalesmanHelpers.DirectedTavelingSalesmanCostHelper(nodes, edges);
        ...
        public void Test1(string inputFile)
        {
            string directory = Path.GetDirectoryName(inputFile);
            string file = Path.GetFileNameWithoutExtension(inputFile);
            var outputFile = @$"{directory}\TravelingSalesmanProblem\TSPCost\Undirected\{file}";
            var expectedfile = @$"{outputFile}.a";
            var resultsfile = $"{outputFile}.r";
            ...
            List<string> actual = TavelingSalesmanHelpers.UndirectedTavelingSalesmanCostHelper(nodes, edges);
            File.WriteAllLines(resultsfile, actual);
        ...
        [Theory]
        [MemberData(nameof(GetInputFiles))]
        public void Test3(string inputFile)
        {
            string directory = Path.GetDirectoryName(inputFile);
            string file = Path.GetFileNameWithoutExtension(inputFile);
            var outputFile = @$"{directory}\TravelingSalesmanProblem\TSPPath\Directed\{file}";
            var expectedfile = @$"{outputFile}.a";
            var resultsfile = $"{outputFile}.r";
            ...
            List<string> actual = TavelingSalesmanHelpers.DirectedTavelingSalesmanPathHelper(nodes, edges, outputFile);
            File.WriteAllLines(resultsfile, actual);
        ...
        [Theory]
        [MemberData(nameof(GetInputFiles))]
        public void Test4(string inputFile)
        {
            string directory = Path.GetDirectoryName(inputFile);
            string file = Path.GetFileNameWithoutExtension(inputFile);
            var outputFile = @$"{directory}\TravelingSalesmanProblem\TSPPath\Undirected\{file}";
            var expectedfile = @$"{outputFile}.a";
            var resultsfile = $"{outputFile}.r";
            ...
            List<string> actual = TavelingSalesmanHelpers.UndirectedTavelingSalesmanPathHelper(nodes, edges, outputFile);
            File.WriteAllLines(resultsfile, actual);
