...
namespace Tests
{
    public class DFSVertexDistanceObsTests
    {
        [Theory]
        ...
        public void Test0(string inputFile)
        {
            ...
            var outputFile = @$"{directory}\DFS\VertexDistance\{file}";
            ...
            List<string> actual = Program.DFSVertexDistanceRecorderHelper(nodes, edges);
