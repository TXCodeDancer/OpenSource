...
namespace Tests
{
    public class EdgePredecessorObsTests
    {
        ...
        public void Test0(string inputFile)
        {
            ...
            List<string> actual = Program.EdgePredecessorObserverHelper(nodes, edges);
        ...
        public void Test1(string inputFile)
        {
            ...
            List<string> actual = Program.EdgePredecessorPathObserverHelper(nodes, edges, nodes.Last());
            File.WriteAllLines(resultsfile, actual);
