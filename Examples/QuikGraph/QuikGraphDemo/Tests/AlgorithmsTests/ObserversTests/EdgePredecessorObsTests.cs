...
namespace Tests
{
    public class EdgePredecessorObsTests
    {
        [Theory]
        ...
        public void Test0(string inputFile)
        {
            ...
            List<string> actual = Program.DFSEdgePredecessorRecorderHelper(nodes, edges);
        ...
        public void Test1(string inputFile)
        {
            ...
            List<string> actual = Program.DFSEdgePredecessorPathRecorderHelper(nodes, edges, nodes.Last());
            File.WriteAllLines(resultsfile, actual);
