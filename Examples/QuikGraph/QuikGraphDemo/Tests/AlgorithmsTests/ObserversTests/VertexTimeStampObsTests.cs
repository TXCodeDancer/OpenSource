...
namespace Tests
{
    public class VertexTimeStampObsTests
    {
        ...
        public void Test0(string inputFile)
        {
            ...
            List<string> actual = Program.DFSVertexDiscoverTimeStampRecorderHelper(nodes, edges);
        ...
        public void Test1(string inputFile)
        {
            ...
            List<string> actual = Program.DFSVertexFinishTimeStampRecorderHelper(nodes, edges);
            File.WriteAllLines(resultsfile, actual);
