...
namespace Tests.AlgorithmsTests.Search
{
    public class BreadthFirstSearchTests
    {
        ...
        public void Test0(string inputFile)
        {
            ...
            var outputFile = @$"{directory}\Search\BreadthFirst\{file}";
            ...
            var actual = SearchHelper.BreadthFirstSearchVertexPaths(nodes, edges);
            actual = SearchHelper.BreadthFirstSearchVertexPredecessor(nodes, edges);
