...
namespace Tests
{
    public class DFSUndirectedVertexDistanceRecorderTests
    {
        [Theory]
        ...
        public void Test0(string inputFile)
        {
            ...
            var outputFile = @$"{directory}\DFS\UndirectedVertexDistanceRecorder\{file}";
            ...
            List<string> actual = Program.DFSUndirectedVertexDistanceRecorderHelper(nodes, edges, inputFile);
